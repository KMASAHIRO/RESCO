...
if __name__ == "__main__":
    ...
    for i in range(len(exp_list)):
        ...
        delay_fig_path = fig_dir + dir_name + "_PCA_delay_grad.png"
        ...
        ax_pca_delay.scatter(pca_vectors_sort[:, 0], pca_vectors_sort[:, 1], s=5, c=delay_means_sort, cmap="jet", marker=".", label="delay")
